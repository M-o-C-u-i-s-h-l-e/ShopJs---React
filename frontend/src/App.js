    ...
    <Router>
      ...
      <main className='py-3'>
        <Container>
          ...
          <Route exact path='/products/category/:category' component={SingleCategoryScreen} />
          <Route exact path='/products/category/:category/:pageNumber' component={SingleCategoryScreen} />
        </Container>
      </main>
      <Footer />
    </Router>
